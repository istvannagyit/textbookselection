...
<div class="row-fluid">
	<div class="span9">
		...
		<div id="viewport" class="row-fluid" <?php if($_SERVER['REQUEST_URI']=="/"){echo 'style="width:135%"';}?> >
		    <?php echo $content; ?>
	    </div>
	</div>
	
	<div class="span3" <?php if($_SERVER['REQUEST_URI']=="/"){echo 'style="display:none"';}?> >
        ...
        <div id="shoppingcartcheckout" onclick="window.location.href='<?php echo Yii::app()->createUrl('cart/checkout') ?>'">
            <div class="checkoutlink"><?php echo CHtml::link(Yii::t('cart','<i class="fa fa-check-circle"></i>&nbsp;Checkout'),array('cart/checkout')) ?></div>
        ...
        <div id="shoppingcarteditcart" onclick="window.location.href='<?php echo Yii::app()->createUrl('/cart') ?>'">
            <div class="editlink"><?php echo CHtml::link(Yii::t('cart','<i class="fa fa-pencil"></i>&nbsp;Edit Cart'),array('/cart')) ?></div>
        </div>
