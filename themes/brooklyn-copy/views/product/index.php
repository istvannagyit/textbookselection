		...
		<div class="row-fluid">
	        ...
	        <div class="span7">
	            <div class="row productheader">
	                <h1 class="title">
	                <?= CHtml::tag('div',array('id'=>CHtml::activeId($model,'title')),$model->WebShortDescription); ?>
	                <!-- old title <?= CHtml::tag('div',array('id'=>CHtml::activeId($model,'title')),$model->Title); ?>-->
	                </h1>
	            ...
	            <?php if (!_xls_get_conf('DISABLE_CART', false)): ?>
		            <div class="row">
			            ...
			            ),CHtml::link(Yii::t('product', '<i class="fa fa-shopping-cart"></i>&nbsp;Add to Cart'), '#'));
			            ?>
                    ...
                    <div class="row">
			            <?php if (_xls_get_conf('ENABLE_WISH_LIST'))
				            ...
				            ),CHtml::link(Yii::t('product', '<i class="fa fa-heart" style="color: #FF0000;"></i>&nbsp;Add to Wish List'), '#'));
			            ?>
					</div>
